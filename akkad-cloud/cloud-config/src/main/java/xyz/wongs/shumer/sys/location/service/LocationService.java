package xyz.wongs.shumer.sys.location.service;
...
import xyz.wongs.shumer.sys.location.entity.Location;
import xyz.wongs.shumer.sys.location.mapper.LocationMapper;
